...
# 30 7 代表 UTC (國際標準時間) 07:30，即台灣 15:30
echo "30 7 * * 1-5 curl -X POST http://localhost:5001/api/update_data -H \"Content-Type: application/json\" -d '{}' >> /var/log/cron.log 2>&1" > /etc/cron.d/stock-cron
